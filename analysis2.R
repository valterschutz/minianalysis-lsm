...
is_holiday_or_weekend <- bd$is_holiday | bd$is_weekend
bd$is_holiday_or_weekend <- factor(is_holiday_or_weekend, levels=c(FALSE,TRUE), labels=c("Not holiday/weekend","Holiday/weekend"))
